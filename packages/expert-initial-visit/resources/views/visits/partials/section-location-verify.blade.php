<div class="card mb-4" style="border-radius:12px;border:none;box-shadow:0 4px 20px rgba(0,0,0,0.08);">
    ...
    <div class="card-body p-4">
        <div class="row g-4">
            ...
            <div class="col-md-6">
                <label class="form-label fw-semibold mb-2">محل بازدید با محل اعلام‌شده مطابقت دارد؟ <span class="text-danger">*</span></label>
                <div class="d-flex gap-4 p-3 @error('location_matches') border border-danger @enderror" style="background:#F5F5F5;border-radius:8px;">
                ...
                @error('location_matches')<div class="text-danger small mt-1">{{ $message }}</div>@enderror
            </div>
            ...
            <div class="col-12" id="actual_address_row" style="{{ old('location_matches')==='0' ? '' : 'display:none;' }}">
                ...
                <textarea name="actual_address" rows="2" class="form-control"
                          style="border-radius:8px;">{{ old('actual_address') }}</textarea>
            </div>

            <div class="col-md-6">
                <label class="form-label fw-semibold mb-2">وجود فیزیکی محل تأیید می‌شود؟ <span class="text-danger">*</span></label>
                <div class="d-flex gap-4 p-3 @error('location_physically_confirmed') border border-danger @enderror" style="background:#F5F5F5;border-radius:8px;">
                    <div class="form-check">
                ...
                @error('location_physically_confirmed')<div class="text-danger small mt-1">{{ $message }}</div>@enderror
            </div>
