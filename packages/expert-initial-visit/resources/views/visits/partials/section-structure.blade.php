    ...
    <div class="card-body p-4">
        <div class="row g-4">
            ...
            <div class="col-md-3">
                ...
                <div class="d-flex gap-4 p-3 @error('reinforcement_needed') border border-danger @enderror" style="background:#F5F5F5;border-radius:8px;">
                ...
                @error('reinforcement_needed')<div class="text-danger small mt-1">{{ $message }}</div>@enderror
            </div>

            <div class="col-md-3">
                <label class="form-label fw-semibold mb-2">نیاز به سازه خاص: <span class="text-danger">*</span></label>
                <div class="d-flex gap-4 p-3 @error('special_structure_needed') border border-danger @enderror" style="background:#F5F5F5;border-radius:8px;">
                    @foreach(['1'=>'بله','0'=>'خیر'] as $v=>$l)
                    <div class="form-check">
                ...
                @error('special_structure_needed')<div class="text-danger small mt-1">{{ $message }}</div>@enderror
            </div>
            ...
            <div class="col-12">
                ...
                <textarea name="structure_notes" rows="2" class="form-control"
                          style="border-radius:8px;">{{ old('structure_notes') }}</textarea>
            </div>
