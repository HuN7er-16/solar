    ...
    <div class="card-body p-4">
        <div class="row g-4">
            ...
            <div class="col-md-4">
                ...
                <div class="d-flex gap-4 p-3 @error('electricity_type') border border-danger @enderror" style="background:#F5F5F5;border-radius:8px;">
            ...
            <div class="col-md-4">
                ...
                <input type="number" name="connection_capacity_ampere" min="0" class="form-control"
                       value="{{ old('connection_capacity_ampere') }}" style="border-radius:8px;">
            </div>

            <div class="col-md-4">
                <label class="form-label fw-semibold mb-2">تابلو برق اصلی قابل دسترسی است؟ <span class="text-danger">*</span></label>
                <div class="d-flex gap-4 p-3 @error('main_panel_accessible') border border-danger @enderror" style="background:#F5F5F5;border-radius:8px;">
                ...
                @error('main_panel_accessible')<div class="text-danger small mt-1">{{ $message }}</div>@enderror
            </div>
            ...
            <div class="col-md-4">
                ...
                <div class="d-flex gap-4 p-3 @error('grid_connection_possible') border border-danger @enderror" style="background:#F5F5F5;border-radius:8px;">
                    @foreach(['1'=>'بله','0'=>'خیر'] as $v=>$l)
                    <div class="form-check">
                ...
                @error('grid_connection_possible')<div class="text-danger small mt-1">{{ $message }}</div>@enderror
            </div>

            <div class="col-md-4">
                <label class="form-label fw-semibold mb-2">نیاز به اصلاح تأسیسات برق: <span class="text-danger">*</span></label>
                <div class="d-flex gap-4 p-3 @error('electrical_fix_needed') border border-danger @enderror" style="background:#F5F5F5;border-radius:8px;">
                    @foreach(['1'=>'بله','0'=>'خیر'] as $v=>$l)
                    <div class="form-check">
                ...
                @error('electrical_fix_needed')<div class="text-danger small mt-1">{{ $message }}</div>@enderror
            </div>
            ...
            <div class="col-12">
                ...
                <textarea name="electrical_notes" rows="2" class="form-control"
                          style="border-radius:8px;">{{ old('electrical_notes') }}</textarea>
            </div>
