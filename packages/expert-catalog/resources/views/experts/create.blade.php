    ...
    <div class="container-fluid" style="direction: rtl; text-align: right;">
        ...
        <div class="mb-4 p-4 text-white"
            ...
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                <div>
                    <h3 class="mb-1 fw-bold"><i class="fa fa-user-plus ms-2"></i>افزودن کارشناس جدید</h3>
                    <p class="mb-0 opacity-90">ثبت اطلاعات شخصی و دسترسی کارشناس بررسی تقاضا</p>
                </div>
        ...
        <div class="card" style="border-radius:12px;border:none;box-shadow:0 4px 20px rgba(0,0,0,0.08);">
            <div class="card-body p-5">
                <form method="POST" action="{{ route('expert-catalog.store') }}">
                    @csrf
                    ...
                    <fieldset class="mb-5">
                        <div class="d-flex align-items-center mb-4">
                            ...
                            <div>
                                ...
                                <p class="mb-0 text-muted small">حساب کاربری برای دسترسی کارشناس به سامانه</p>
                            </div>
                        </div>
                        <div style="height:3px;background:linear-gradient(90deg,#7986CB,#5C6BC0);border-radius:3px;margin-bottom:24px;"></div>
                        <div class="row g-4">
                            <div class="col-md-8">
                                <label class="form-label fw-semibold mb-2" style="color:#37474F;">
                                ...
                                <small class="text-muted d-block mt-2" style="font-size:13px;">
                                    <i class="fa fa-info-circle ms-1" style="color:#5C6BC0;"></i>
                                    فقط کاربرانی که هنوز پروفایل کارشناس ندارند نمایش داده می‌شوند.
                                </small>
                            </div>
                        </div>
                    </fieldset>
                    ...
                    <fieldset class="mb-5">
                        <div class="d-flex align-items-center mb-4">
                            ...
                            <div>
                                ...
                                <p class="mb-0 text-muted small">کد کارشناس و مشخصات هویتی</p>
                            </div>
                        </div>
                        <div style="height:3px;background:linear-gradient(90deg,#7986CB,#5C6BC0);border-radius:3px;margin-bottom:24px;"></div>
                        <div class="row g-4">
                            <div class="col-md-3">
                                ...
                                <input type="text" name="expert_code"
                                       ...
                                       value="{{ old('expert_code') }}" required
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" name="national_id"
                                       ...
                                       value="{{ old('national_id') }}" required maxlength="10" placeholder="۱۰ رقم"
                                       style="border-radius:10px;border:2px solid #E0E0E0;padding:12px 16px;font-family:'Vazir',monospace;">
                                @error('national_id')
                                    <div class="text-danger small mt-2"><i class="fa fa-exclamation-circle ms-1"></i>{{ $message }}</div>
                                @enderror
                    ...
                    <fieldset class="mb-5">
                        <div class="d-flex align-items-center mb-4">
                            ...
                            <div>
                                ...
                                <p class="mb-0 text-muted small">شماره موبایل و تلفن ثابت</p>
                            </div>
                        </div>
                        ...
                        <div class="row g-4">
                            <div class="col-md-4">
                                ...
                                <input type="text" name="mobile"
                                       ...
                                       value="{{ old('mobile') }}" required maxlength="11" placeholder="۰۹XXXXXXXXX"
                                       style="border-radius:10px;border:2px solid #E0E0E0;padding:12px 16px;font-family:'Vazir',monospace;">
                                @error('mobile')
                                    <div class="text-danger small mt-2"><i class="fa fa-exclamation-circle ms-1"></i>{{ $message }}</div>
                                @enderror
                    ...
                    <fieldset class="mb-5">
                        <div class="d-flex align-items-center mb-4">
                            ...
                            <div>
                                ...
                                <p class="mb-0 text-muted small">استان، شهر و آدرس</p>
                            </div>
                        </div>
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="address" rows="3"
                                          ...
                                          required
                                          style="border-radius:10px;border:2px solid #E0E0E0;padding:12px 16px;resize:vertical;">{{ old('address') }}</textarea>
                                @error('address')
                                    <div class="text-danger small mt-2"><i class="fa fa-exclamation-circle ms-1"></i>{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <fieldset class="mb-5">
                        <div class="d-flex align-items-center mb-4">
                            ...
                            <div>
                                ...
                                <p class="mb-0 text-muted small">وضعیت گواهی حرفه‌ای</p>
                            </div>
                        </div>
                                ...
                                <div class="d-flex gap-4 mt-1 p-3" style="background:#FFF3E0;border-radius:10px;">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="is_certificated"
                                               id="cert_yes" value="1"
                                               {{ old('is_certificated') == '1' ? 'checked' : '' }}
                                               style="width:20px;height:20px;cursor:pointer;">
                                        <label class="form-check-label fw-semibold me-2" for="cert_yes"
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="is_certificated"
                                               id="cert_no" value="0"
                                               {{ old('is_certificated', '0') == '0' ? 'checked' : '' }}
                                               style="width:20px;height:20px;cursor:pointer;">
                                        <label class="form-check-label fw-semibold me-2" for="cert_no"
                    ...
                    <div class="mt-5 d-flex gap-3 justify-content-end flex-wrap">
                        ...
                        <button type="submit" class="btn btn-lg text-white"
                            ...
                            <i class="fa fa-save ms-1"></i> ثبت کارشناس
                        </button>
                    </div>
                </form>
            </div>
